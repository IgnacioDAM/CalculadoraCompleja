...
public class Calculadora extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Bindings.bindBidirectional(resultado1.textProperty(), complejaResultante.realProperty(), new NumberStringConverter());
		Bindings.bindBidirectional(resultado2.textProperty(), complejaResultante.imaginarioProperty(), new NumberStringConverter());
	...
	private void onOperacionAction() {
		...
		if(operacion.equals("+")) {
			...
			complejaResultante.imaginarioProperty().bind(complejaA.imaginarioProperty().add(complejaB.imaginarioProperty()));
		
		} else if (operacion.equals("-")) {
			complejaResultante.realProperty().bind(complejaA.realProperty().subtract(complejaB.realProperty()));
			
			complejaResultante.imaginarioProperty().bind(complejaA.imaginarioProperty().subtract(complejaB.imaginarioProperty()));
			...
			complejaResultante.imaginarioProperty().bind(complejaA.realProperty().multiply(complejaB.imaginarioProperty())
					.add(complejaA.imaginarioProperty().multiply(complejaB.realProperty())));
		
		}else {
			complejaResultante.realProperty().bind(complejaA.realProperty().multiply(complejaB.realProperty()).add(complejaA.imaginarioProperty().multiply(complejaB.imaginarioProperty())
					.divide(complejaB.realProperty()).multiply(complejaB.realProperty()).add(complejaB.imaginarioProperty().multiply(complejaB.imaginarioProperty()))));
			
			complejaResultante.imaginarioProperty().bind(complejaA.imaginarioProperty().multiply(complejaB.realProperty()).subtract(complejaA.realProperty().multiply(complejaB.imaginarioProperty())
					.divide(complejaB.realProperty()).multiply(complejaB.realProperty()).add(complejaB.imaginarioProperty().multiply(complejaB.imaginarioProperty()))));
		}
